...
if __name__ == '__main__':
    ...
    print(net(x).shape)
    exit()
    # torch.save(net.state_dict(), "a.pt")
    net.eval()
    net.load_state_dict(torch.load('../weight/weights_AB1.pt'))
    a = torch.jit.trace(net, x)
    a.save(r'../weight/net_airway_AB1.pt')
    [10, 'D'], [9, 'AB1']
    net = torch.jit.load(r'../weight/net_airway_AB1.pt')
